...
<form name="formsale" action="saveform.php" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data" >	
	...
	<div class='product' style="background:#ffffff;margin:0 80px">
         <fieldset >
            <legend><strong>ข้อมูลแผนก</strong></legend>

            
            
            <label style="width:150px;display:block;float:left;margin-top:8px">ชื่อแผนก : </label><input type="text" name="titleTh" id="titleTh" value="<?=$titleTh;?>" style="width:500px" />
            <br style="clear:left"/>
            ...
            <br style="clear:left"/>
             ...
             <div style="margin:10px 0">
                  <label style="float:left;">แกลอรี่ : <font color="red">ทำเครื่องหมายรูปที่ต้องการลบ</font></label>
