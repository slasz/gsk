...
<?
if(!empty($getmid)){
	$sqlM=mysql_query("select m_id,m_country,m_map,m_mail,m_flag,m_pic,m_sorter,
	...
	if(mysql_num_rows($sqlM)>0){
		list($m_id,$m_country,$m_map,$m_mail,$m_flag,$m_pic,$m_sorter,
		$m_b1,$m_b2,$m_b3,$m_b4,$m_b5,$m_b6,$m_b7,$m_b8,$m_b9,$m_b10,$m_f1,$m_f2,$m_f3,$m_f4,$m_f5,$m_f6,$m_f7,$m_f8,$m_f9,$m_f10
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="95%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f1;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b1;?></td>
          </tr>
          <? } else{}  if(!empty($m_f2) && !empty($m_b2)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f2;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b2;?></td>
          </tr>
          <? } else{}  if(!empty($m_f3) && !empty($m_b3)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f3;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b3;?></td>
          </tr>
          <? } else{}  if(!empty($m_f4) && !empty($m_b4)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f4;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b4;?></td>
          </tr>
          <? } else{}  if(!empty($m_f5) && !empty($m_b5)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f5;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b5;?></td>
          </tr>
          <? } else{}  if(!empty($m_f6) && !empty($m_b6)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f6;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b6;?></td>
          </tr>
          <? } else{}  if(!empty($m_f7) && !empty($m_b7)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f7;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b7;?></td>
          </tr>
          <? } else{}  if(!empty($m_f8) && !empty($m_b8)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f8;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b8;?></td>
          </tr>
          <? } else{}  if(!empty($m_f9) && !empty($m_b9)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f9;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b9;?></td>
          </tr>
          <? } else{}  if(!empty($m_f10) && !empty($m_b10)){ ?>
          <tr>
            <td width="30%" style="border-bottom:1px #CCCCCC solid;"><strong><?=$m_f10;?></strong></td>
            <td width="70%" style="border-bottom:1px #CCCCCC solid;"><?=$m_b10;?></td>
          </tr>
          <? } else{}  if(!empty($m_mail)){ ?>
          <tr>
            <td colspan="2" style="border-bottom:0px #CCCCCC solid;">
            <strong><a href ="<?=$m_mail;?>" style="color:#060a27; text-decoration:none;"><i class="fa fa-envelope fa-1x"></i> Send E-mail</a></strong></td>
            </tr>
...
?>
			<table width="560" border="0" cellspacing="0" cellpadding="0" style="margin-right:25px;">
<tr>
            <td colspan="2" bgcolor="#97D9EE" style="border-bottom:1px #CCCCCC solid; padding-left:5px;"><strong><?=$s_country;?></strong></td>
            </tr>
          <? if(!empty($s_f1) && !empty($s_b1)){ ?>
          <tr>
...
<?
if(!empty($getmid)){
	$sqlEM=mysql_query("select id,titleTh,main_id from news where main_id='$getmid' ") ;
                                ...
                                <table width="0"  border="0" cellpadding="0" cellspacing="0" align="center" >
                                  <tr valign="top">
                                    <td align="center" valign="top">
                                     ...
                                     <a href="login/news/gallery/<?=$pic;?>" rel="lightbox[roadtrip]" ><img src="login/news/gallery/<?=$pic;?>" style="border:#CCCCCC 0px solid; width:200px; height:260px;" /></a>   
                                     
                                    <center><div style="width:200px; margin-top:0px;">
									<?=$emname;?><br />
									<?=$emposition;?><br />
                                    </div></center> 
                                                                      </td>
