...
<a href="?p=branner/index" style="position:relative;float:right;margin:-10px 10px" ><h4>Back page</h4></a>

<ul class="product" style="padding:5px;magin:0;height:20px">

    <li><h3 style="padding:0;margin:0;">Slide setting</h3></li>
...
<tr>
                ...
                <tr>
                  ...
                  <td valign="top" nowrap>Banner<br></td>
               ...
               <!-- <tr>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><p><font color="#FF0000">Size</font><font color="#FF0000"> &nbsp;&nbsp;1169*314 pixel (Only .gif .jpg .jpeg .png  )
                  <!--<br />
