...
<form name="formsale" action="saveform.php" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data" >	
	...
	<div class='product' style="background:#ffffff;margin:0 80px">
         <fieldset >
            ...
            <label style="width:150px;display:block;float:left;margin-top:8px">ชื่อสาขาใหญ่ : </label><input type="text" name="m_name" id="m_name" value="<?=$m_name;?>" style="width:500px" />
            <br style="clear:left"/>
