...
if(!empty($getid)){
	$edit=mysql_query("select p.proid,p.titleTh,p.topicTh,p.detailTh,p.titleEn,p.topicEn,p.detailEn,p.titleJp,p.topicJp,p.detailJp, p.p0, p.p2,p.hot,p.showindex,p.n_month,p.n_year"
	." from promotion p"
	." where p.proid=".$getid 
	)or die(mysql_error());
	
	if(mysql_num_rows($edit)>0){
		list($proid,$titleTh,$topicTh,$detailTh,$titleEn,$topicEn,$detailEn,$titleJp,$topicJp,$detailJp,$p0,$p2,$hot,$showindex,$mount,$year)=mysql_fetch_array($edit);
}
...
<form name="formsale" action="saveform.php" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data" >	
    ...
    <h4 class="ui-widget-content ui-widget-header ui-corner-all" style="margin:0 100px;padding:4px 10px">Please fill out</h4>
...
<div id="tabs" style="width:806px;margin:10px 100px 0 0px"><strong>Category : 
                 </strong>
   <label>
   <?=$msg;?>
   </label>
   ...
   <div id="tabs" style="width:806px;margin:10px 100px 0 0px"><strong>photo main page : 
                      ...
                      <font color="red">Size 500*250</font><br />
      </div>
      
   <div id="tabs" style="width:806px;margin:10px 100px 0 0px"><strong>photo content : 
                 </strong> <?=(!empty($p2))?"<img src='../upload/promotions/".$p2."' width='432' height='258'><br/>":""?>
                      
                      <input name="fileN2" type="file" class="inputbox" id="fileN2"/>
                      
                      <input type="hidden" id="oldpic2" name="oldpic2" value="<?=$p2?>">
                      
                      
                      <font color="red">Size 800*600</font><br />
      </div>
      ...
      <div id="tabs" style="width:806px;margin:10px 100px 0 0px; display:none;"><strong>แสดง icon Hot : 
          ...
          <div id="tabs" style="width:806px;margin:10px 100px 0 0px; "><strong>Show main page : 
...
?>   
         <div id="tabs" style="width:806px;margin:10px 100px 0 0px; "><strong>Month / Year : 
                 </strong>
           ...
           <span class="style1">*Put A.D. : example 2014*</span><br />
      </div>
    <? } else { }?>  
...
<!--<div class="product" ><strong>หัวข้อ:</strong> <br />
     ...
     <div class="product" ><strong>Head line:</strong><br />
       <textarea name="topicTh" cols="125" rows="5" id="topicTh" style="width:500px;"><?=$topicTh?></textarea>
      </div>
     
     
      <div class="product" ><strong>Detail:</strong><br />
        <textarea name="detailTh" cols="125" rows="30" id="detailTh" style="width:500px;"><?=$detailTh?></textarea>
      </div>
   </div> 
