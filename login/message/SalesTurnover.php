...
mysql_query("update messageweb set 
	p0='".$fileRename0."'  where id='$id' ") or die(mysql_error());
	echo "<script>self.location='?p=message/SalesTurnover';</script>";
    ...
    <div style="border:solid 0px #666666;padding:20px;margin:5px 0x;">
     ...
     <div id="tabs1">
    	 <ul style="padding:0;margin:0;">
         	<li><a href="#tabs-1" style="padding:2px 8px;">Sales Turnover</a></li>
