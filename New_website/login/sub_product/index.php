...
<input type="button" value="เพิ่มบริการ" onclick="javascript:location='?p=sub_product/form<?=$ll;?>';" />
<div align="right" style="margin:10px 0">

<label style="float:left">ค้นหาจาก <select id="main_id" name="main_id" style="font-size:13px" onchange="location='?p=sub_product/index&mid='+this.value;"><option value="">หมวดหมู่</option><?=$selCate?></select></label>
...
<table width="100%" border="0" cellpadding="7" cellspacing="1" bgcolor="#FFFFFF" >
  <tr bgcolor="#FF9900" class="top" >
    ...
    <td width="43%" align="center">สาขาย่อย</td>
    <td width="25%" align="center">ประเทศ</td>
    <td width="22%" align="center">เครื่องมือ</td>
  </tr>
...
?>
  ...
  <tr>
    ...
    <a href='?p=sub_product/form&id=<?=$s_id;?>'  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>แก้ไข</a>    </td>
  </tr>
