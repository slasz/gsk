                                ...
                                <table width="200"  border="0" cellpadding="0" cellspacing="5" align="center" style="margin:auto 5px;">
                                  <tr valign="top">
                                    <td align="center" valign="top" style="padding:auto 10px;">
                                     ...
                                     <a href="gengEM.php?filedir=login/news/gallery/<?=$pic;?>" rel="lightbox[roadtrip]" ><img src="login/news/gallery/<?=$pic;?>" style="border:#CCCCCC 0px solid; width:120px; height:170px;" /></a>   
                                     
                                    <center><div style="width:200px; margin-top:20px;">
									<?=$emname;?><br />
									<?=$emposition;?><br />
                                    </div></center> 
                                                                      </td>
