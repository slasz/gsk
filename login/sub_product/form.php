...
<form name="formsale" action="saveform.php" method="post" onSubmit="return checkform(this)" enctype="multipart/form-data" >	
	...
	<div class='product' style="background:#ffffff;margin:0 80px">
         <fieldset >
            <legend><strong>Sub Branch detail</strong></legend>

            
            
      <label style="width:250px;display:block;float:left;margin-top:8px">Company name of sub branch : </label>
<input type="text" name="s_country" id="s_country" value="<?=$s_country;?>" style="width:500px" />
            <br style="clear:left"/>
            
             <label style="width:250px;display:block;float:left;margin-top:8px">Country : </label><?=$strCategory?>
    
            <br style="clear:left"/>
            
   
            
<label style="width:250px;display:block;float:left;margin-top:8px">Map : </label><input type="text" name="s_map" id="s_map" value="<?=$s_map;?>" style="width:500px" />
            <br style="clear:left"/>
