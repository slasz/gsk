...
if($file_name != ""){
	...
	$str1="insert into promotion(titleTh,topicTh,detailTh,titleEn,topicEn,detailEn,titleJp,topicJp,detailJp,p0,status,hot,showindex,n_date,n_month,n_year) values('".$titleTh."','".$topicTh."','".$detailTh."','".$titleEn."','".$topicEn."','".$detailEn."','".$titleJp."','".$topicJp."','".$detailJp."','".$fileRename0."','".$status."','".$hot."','".$showindex."','".$n_date."','".$n_month."','".$n_year."')";

} else{

	$str1="update promotion set titleTh='".$titleTh."',topicTh='".$topicTh."', detailTh='".$detailTh."',titleEn='".$titleEn."',topicEn='".$topicEn."', detailEn='".$detailEn."',titleJp='".$titleJp."',topicJp='".$topicJp."', detailJp='".$detailJp."', p0='".$fileRename0."',status='".$status."',hot='".$hot."', showindex='".$showindex."' , n_month='".$n_month."', n_year='".$n_year."' where proid=".$id;
	...
	//echo "$gind=>$gval<br/>";
		...
		$sql = "INSERT INTO news(titleTh,main_id,sortder) VALUES ('$titleTh','$main_id','9999')";
		 ...
		 if($result)
			...
			echo "<center style='margin:300px 0'><h3>บันทึกไม่ได้.้<br/>กรุณาลองอีกครั้ง หรือติดต่อผู้พัฒนาระบบ.</h3>".mysql_error()."</center>";
			echo "<script>setTimeout(\"self.location='$refer';\",5000)</script>";
			exit();
				}	
