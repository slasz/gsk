	...
	$cs=($clipshow=='y')?"checked":""; 
			...
			$result.=
				 ...
				 <td  style='width:5%;height:30px;padding-left:10px;'><input type='checkbox' name='del[]' value='".$clipid."'></td>
				  ...
				  <a href='clip/form.php?cpid=".$clipid."&cpname=".$clipname."&cpshow=".$clipshow."' rel='facebox'  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>แก้ไข</a>

				  <a href='clip/views.php?urlclip=".$clipname."' onClick=\"NewWindow(this.href,'name','585','335','yes','');return false;\"  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>ดูคลิป</a></td></tr></table>";
...
<div style="height:28px">&nbsp;
	...
	<ul class="tblrow" style="position:absolute;margin:-13px 0 0 0px;font-size:15px;font-weight:normal;">
        ...
        <li class="tblclm" style="width:630px">ลิงค์วีดีโอ</li>
