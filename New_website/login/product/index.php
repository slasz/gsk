...
<input type="button" value="เพิ่มบริการ" onclick="javascript:location='?p=product/form&catid=<?=$getCat;?>';" />
...
<table width="100%" border="0" cellpadding="7" cellspacing="1" bgcolor="#FFFFFF" >
  <tr bgcolor="#FF9900" class="top" >
    ...
    <td width="53%" align="center">สาขาประเทศ</td>
    <td width="36%" align="center">เครื่องมือ</td>
  </tr>
...
?>
  ...
  <tr bgcolor="#F7F7F7">
    ...
    <a href='?p=product/form&id=<?=$m_id;?>'  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>แก้ไข</a>
    
    <a href='?p=sub_product/index&mid=<?=$m_id;?>'  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>สาขาย่อย</a>
    
    <a href='?p=news/index&mid=<?=$m_id;?>'  class='ui-widget-header  ui-corner-all' style='padding:1px;margin'>ข้อมูลพนักงาน</a>    </td>
  </tr>
...
<input type="button" name="btn" value="บันทึกข้อมูล" onclick=
"if(updateproduct('M_Branch','saveform.php',displaymain)==true){alert('บันทึกเรียบร้อยค่ะ');self.location='administrator.php?p=product/index';} "/>
</center>
