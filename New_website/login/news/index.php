                ...
                <tr >
                  <td colspan="6" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
                    ...
                    <tr>
                      ...
                      <a href="?p=news/form<?=$ll;?>" style="font-size:14px; font-weight:bold; padding:5px 10px; background:#F4F4F4; border:1px #C7C7C7 solid; margin:5px;-moz-border-radius: 3px;-webkit-border-radius:3px; "><strong>เพิ่มแผนก</strong>&nbsp;</a>                      </td>
                      <td width="48%"><div align="right"><span class="txt02">ข้อมูลทั้งหมด&nbsp; <?php echo $page;?> &nbsp;หน้า &nbsp;
                        ปัจจุบันหน้าที่&nbsp;&nbsp;
                          </span>
                    ...
                    <tr>
                      <td><label style="float:left">ค้นหาจาก <select id="main_id" name="main_id" style="font-size:13px" onchange="location='?p=news/index&mid='+this.value;"><?=$selCate?></select></label></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
                </tr>
...
<a href="?p=news/test&id=<?php echo $row['id']; ?><?php echo $ll; ?>"  class='ui-widget-header  ui-corner-all' style='padding:1px;'>เพิ่มรูปพนักงาน</a>
<a href="?p=news/form&amp;id=<?php echo $row['id']; ?><?=$ll;?>"  class='ui-widget-header  ui-corner-all' style='padding:1px;'>แก้ไข</a></font></div></td>
