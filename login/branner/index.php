...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
          <tr>
            <td><div align="right"><span class="txt02">Total&nbsp; <?php echo $page;?> &nbsp;page &nbsp;
              Current Page&nbsp;&nbsp;
      ...
      <tr>
        <td><div align="left">
            <p class="txt1"><strong><a href='?p=branner/form'>Add Banner</a></strong><br>          </p>
              ...
              <table width="600" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="txt1">
                <tr >
                 ...
                 <!-- <td width="300" >ชื่อ</td>-->
                  <td>Slide Picture</td>
                  <td width="22" ><div align="center">Delete</div></td>
                  <td width="22" ><div align="center">Sort</div></td>
